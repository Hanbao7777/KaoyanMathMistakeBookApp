...
const definitions: Record<OperationName, DescriptorDefinition> = {
  ...
  'agent.r4_grants.create': managementCommand(['r4.manage'], 'R3', { approval: 'always' }),
  'agent.r4_grants.revoke': managementCommand(['r4.manage'], 'R2'),
  'agent.approvals.approve': managementCommand(['approvals.manage'], 'R2'),
  'agent.approvals.reject': managementCommand(['approvals.manage'], 'R2'),
  'agent.changesets.apply': managementCommand(['changesets.manage'], 'R3', { approval: 'policy', requiresChangeSet: true, maxAffectedEntities: 500 }),
  'agent.changesets.reject': managementCommand(['changesets.manage'], 'R2'),
  ...
  'agent.r4_grants.list': managementQuery(['r4.read']),
  'agent.approvals.list': managementQuery(['approvals.read']),
  'agent.changesets.list': managementQuery(['changesets.read']),
  'agent.changesets.get': managementQuery(['changesets.read']),
