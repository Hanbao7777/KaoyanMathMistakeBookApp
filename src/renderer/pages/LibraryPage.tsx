...
import { CATEGORIES, DIFFICULTIES, ERROR_REASONS, MASTERY_LEVELS, QUESTION_TYPES, SOURCES } from '../../shared/options';
...
function hasActiveFilters(filters: QuestionFilters) {
  return Boolean(filters.search || filters.category || filters.questionType || filters.errorReason || filters.masteryLevel || filters.difficulty || filters.source || filters.tag || filters.weakOnly);
}
